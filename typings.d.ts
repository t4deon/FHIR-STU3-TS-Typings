...
interface AccountCoverage extends Element {
	coverage: Reference;
...
interface ActivityDefinitionParticipant extends Element {
	type: code;
...
interface CapabilityStatementMessagingSupportedMessage extends Element {
	mode: code;
	definition: Reference;
}
...
interface ChargeItemParticipant extends Element {
	role?: CodeableConcept;
	actor: Reference;
}
...
interface ClaimResponseProcessNote extends Element {
	number?: positiveInt;
	type?: CodeableConcept;
	text?: string;
...
interface CommunicationRequestRequester extends Element {
	agent: Reference;
	onBehalfOf?: Reference;
}
...
interface CompositionRelatesTo extends Element {
	code: code;
...
interface ConceptMapGroupUnmapped extends Element {
	mode: code;
	code?: code;
	display?: string;
	url?: uri;
...
interface ConsentActor extends Element {
	role: CodeableConcept;
	reference: Reference;
}
interface ConsentPolicy extends Element {
	authority?: uri;
	uri?: uri;
}
interface ConsentData extends Element {
	meaning: code;
	reference: Reference;
}
...
interface CoverageGrouping extends Element {
	group?: string;
	groupDisplay?: string;
	subGroup?: string;
...
interface DiagnosticReportPerformer extends Element {
	role?: CodeableConcept;
	actor: Reference;
}
...
interface EpisodeOfCareDiagnosis extends Element {
	condition: Reference;
	role?: CodeableConcept;
	rank?: positiveInt;
}
...
interface ExplanationOfBenefitProcessNote extends Element {
	number?: positiveInt;
	type?: CodeableConcept;
	text?: string;
	language?: CodeableConcept;
...
interface GraphDefinitionLink extends Element {
	path: string;
	sliceName?: string;
	min?: integer;
	max?: string;
...
interface GraphDefinitionLinkTarget extends Element {
	type: code;
	profile?: uri;
	compartment?: GraphDefinitionLinkTargetCompartment[];
	link?: GraphDefinitionLink[];
}
interface GraphDefinitionLinkTargetCompartment extends Element {
	code: code;
	rule: code;
	expression?: string;
	description?: string;
...
interface ImmunizationPractitioner extends Element {
	role?: CodeableConcept;
	actor: Reference;
}
...
interface MeasureReportGroupStratifierStratum extends Element {
	value: string;
	population?: MeasureReportGroupStratifierStratumPopulation[];
	measureScore?: decimal;
}
interface MeasureReportGroupStratifierStratumPopulation extends Element {
	identifier?: Identifier;
	code?: CodeableConcept;
	count?: integer;
	patients?: Reference;
...
interface MedicationIngredient extends Element {
	itemCodeableConcept?: CodeableConcept;
	itemReference?: Reference;
	isActive?: boolean;
	amount?: Ratio;
...
interface MedicationPackageBatch extends Element {
	lotNumber?: string;
	expirationDate?: dateTime;
}
...
interface MedicationAdministrationPerformer extends Element {
	actor: Reference;
	onBehalfOf?: Reference;
}
...
interface MedicationDispensePerformer extends Element {
	actor: Reference;
	onBehalfOf?: Reference;
}
...
interface PaymentReconciliationProcessNote extends Element {
	type?: CodeableConcept;
	text?: string;
}
...
interface PlanDefinitionGoal extends Element {
	category?: CodeableConcept;
	description: CodeableConcept;
	priority?: CodeableConcept;
...
interface PlanDefinitionGoalTarget extends Element {
	measure?: CodeableConcept;
	detailQuantity?: Quantity;
	detailRange?: Range;
	detailCodeableConcept?: CodeableConcept;
...
interface PlanDefinitionAction extends Element {
	label?: string;
	title?: string;
	description?: string;
...
interface PlanDefinitionActionCondition extends Element {
	kind: code;
	description?: string;
	language?: string;
	expression?: string;
}
interface PlanDefinitionActionRelatedAction extends Element {
	actionId: id;
	relationship: code;
	offsetDuration?: Duration;
	offsetRange?: Range;
}
interface PlanDefinitionActionParticipant extends Element {
	type: code;
	role?: CodeableConcept;
}
interface PlanDefinitionActionDynamicValue extends Element {
	description?: string;
	path?: string;
	language?: string;
	expression?: string;
...
interface PractitionerRoleAvailableTime extends Element {
	daysOfWeek?: code[];
	allDay?: boolean;
	availableStartTime?: time;
	availableEndTime?: time;
}
interface PractitionerRoleNotAvailable extends Element {
	description: string;
	during?: Period;
}
...
interface ProcessResponseProcessNote extends Element {
	type?: CodeableConcept;
	text?: string;
}
...
interface SpecimenProcessing extends Element {
	description?: string;
...
interface SupplyDeliverySuppliedItem extends Element {
	quantity?: Quantity;
	itemCodeableConcept?: CodeableConcept;
	itemReference?: Reference;
}
...
interface SupplyRequestOrderedItem extends Element {
	quantity: Quantity;
	itemCodeableConcept?: CodeableConcept;
	itemReference?: Reference;
}
interface SupplyRequestRequester extends Element {
	agent: Reference;
	onBehalfOf?: Reference;
}
